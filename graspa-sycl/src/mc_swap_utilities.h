...
Insertion_Body(Components &SystemComponents, Simulations &Sims, ForceField &FF,
               ...
               double &Rosenbluth, bool &SuccessConstruction,
               size_t &SelectedTrial, double &preFactor, bool previous_step,
               double2 newScale)
{
  ...
  //printf("First Bead energy: "); energy.print();
  ...
  if(SystemComponents.Moleculesize[SelectedComponent] > 1 && Rosenbluth > 1e-150)
  {
    ...
    //printf("Chain energy: "); energy.print();
    energy += temp_energy;
  }
